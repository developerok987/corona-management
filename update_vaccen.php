<html>
<head><title>Vaccine Project</title>
...
<div id="wrapper">
            ...
            $result = mysqli_query($con, "select * from vac_storage_center where storage_id='$_GET[id]'");
            while ($row = mysqli_fetch_array($result))
            { ?>
         <form method="POST" action="update_vaccen_class.php">
                 <div class="form-group">
                   ...
                   <div class="form-group">
                       <label> Hospital_id </label>
                           <input type="text" class="form-control" name="hi" value="<?php echo $row ['center_id'] ?>"></input>
                   </div>
                   <div class="form-group">
