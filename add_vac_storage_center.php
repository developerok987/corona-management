            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body"> 
                                ...
                                <form method="POST" action="add_storagecen_class.php" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="units" placeholder="" required></input>
                                </div>
                                <div class="form-group">
                                    <label > Temprature</label>
                                    <input type="text" class="form-control" name="temp" placeholder="" required></input>
                                </div>
                                <div class="form-group">
