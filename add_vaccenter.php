            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header rounded p-3 bg-primary text-white">
                        <span>Add New Vaccination Center</span>
                    </div>
                    <div class="card-body"> 

                          
                                <form method="POST" action="add_vaccenter_class.php" enctype="multipart/form-data" required>
                                ...
                                <div class="form-group">
                                    <label > Address</label>
                                    <input type="text" class="form-control" name="address" placeholder="" required></input>
                                </div>
                                <div class="form-group">
                                    <label > Phone</label>
